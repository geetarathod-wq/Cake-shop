...
->group(function () {
    ...
    */
    Route::prefix('reports')->name('reports.')->group(function () {
        ...
        Route::get('/product-sales', [ReportController::class, 'productWise'])->name('product-sales'); // added to match frontend
        Route::get('/category-wise', [ReportController::class, 'categoryWise'])->name('category-wise');
        Route::get('/category-sales', [ReportController::class, 'categoryWise'])->name('category-sales'); // added
        ...
        Route::get('/custom-orders', [ReportController::class, 'customCakes'])->name('custom-orders'); // added
        ...
        Route::get('/material-usage', [ReportController::class, 'inventoryUsage'])->name('material-usage'); // added
        Route::get('/inventory/low-stock', [ReportController::class, 'lowStock'])->name('inventory.low-stock');
        Route::get('/low-stock', [ReportController::class, 'lowStock'])->name('low-stock'); // added
        Route::get('/inventory/movement', [ReportController::class, 'stockMovement'])->name('inventory.movement');
        Route::get('/stock-movement', [ReportController::class, 'stockMovement'])->name('stock-movement'); // added

        /* Financial */
        Route::get('/financial/profit', [ReportController::class, 'profitMargin'])->name('profit');
        Route::get('/profit-margin', [ReportController::class, 'profitMargin'])->name('profit-margin'); // added
        Route::get('/financial/discounts', [ReportController::class, 'discountReport'])->name('discounts');
        Route::get('/discount-report', [ReportController::class, 'discountReport'])->name('discount-report'); // added
